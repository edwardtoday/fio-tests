...
`libaio` 为 Linux 异步 IO 引擎；本次测试在 t3.medium（cn-north-1）实例上进行。
...
Run status group 0 (all jobs):
   READ: bw=126MiB/s (132MB/s), 126MiB/s-126MiB/s (132MB/s-132MB/s), io=7396MiB (7755MB), run=120134-120134msec

Disk stats (read/write):
  nvme0n1: ios=60542/57, sectors=30997504/664, merge=0/18, ticks=3628662/3337, in_queue=3632000, util=98.34%
